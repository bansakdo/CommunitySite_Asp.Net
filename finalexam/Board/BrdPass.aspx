<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTemplate.Master" AutoEventWireup="true" CodeBehind="BrdPass.aspx.cs" Inherits="finalexam.Board.BrdPass" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table Width="600px" style="text-align:center; margin-left:200px; border:solid 1px; ">
        <tr>
            <td colspan="2" style="height:80px"><h2>게시글 비밀번호 입력</h2></td>
        </tr>
        <tr>
