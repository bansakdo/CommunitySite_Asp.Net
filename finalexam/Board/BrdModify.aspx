<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTemplate.Master" AutoEventWireup="true" CodeBehind="BrdModify.aspx.cs" Inherits="finalexam.Board.BrdModify" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width:85%; text-align:center" >
        <tr>
            <td colspan="2"><h2>게시판 수정하기</h2></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="left" style="padding-left:10px">
                ...
                <asp:RequiredFieldValidator ID="vldNameRequired" runat="server" ErrorMessage="작성자 이름을 입력해주세요." ControlToValidate="txtname" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="padding-top:20px; padding-bottom:20px" >
                <asp:Button ID="btnUpdate" runat="server" Text="수정" OnClick="btnUpdate_Click" Width="150px"/>&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnReset" runat="server" Text="초기화" OnClick="btnReset_Click" Width="150px" CausesValidation="false"/>&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnView" runat="server" Text="돌어가기" OnClick="btnView_Click" Width="150px" CausesValidation="false"/>
            </td>
        </tr>
