<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTemplate.Master" AutoEventWireup="true" CodeBehind="BrdAllList.aspx.cs" Inherits="finalexam.Board.BrdAllList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width:1000px; text-align:center; left:0; right:0; margin:auto;" >
        <tr>
            <td style="border-bottom:solid 1px"><h1><asp:Label ID="lblTitle" runat="server" Text="전체 글 보기" ></asp:Label></h1></td>
        </tr>
        <tr>
            <td style="width:90%">
        ...
        <tr>
            <td style="width:100%; text-align:left; padding-top:30px; padding-left:10px; ">
                <asp:Button ID="btnBrdAdd" runat="server" Text="글 쓰기" OnClick="btnBrdAdd_Click" Width="150px"/>
            </td>
        </tr>
    </table>
</asp:Content>
