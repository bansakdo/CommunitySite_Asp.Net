<%@ Page Title="" Language="C#" MasterPageFile="~/SiteTemplate.Master" AutoEventWireup="true" CodeBehind="BrdNotice.aspx.cs" Inherits="finalexam.Board.BrdNotice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width:1000px; text-align:center; left:0; right:0; margin:auto;" >
        <tr>
            <td style="border-bottom:solid 1px"><h1><asp:Label ID="lblTitle" runat="server" Text="공지사항" ></asp:Label></h1></td>
        </tr>
        <tr>
            <td style="width:90%">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FinalexamConnectionString %>" SelectCommand="SELECT [num], [title], [name], [writedate], [readcnt] FROM [board] WHERE ([category] = 'notice')">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
            <td style="width:100%; text-align:left; padding-top:30px; padding-left:10px; ">
                <asp:Button ID="btnBrdAdd" runat="server" Text="글쓰기" OnClick="btnBrdAdd_Click" Width="150px" Visible="false"/>
            </td>
        </tr>
    </table>
